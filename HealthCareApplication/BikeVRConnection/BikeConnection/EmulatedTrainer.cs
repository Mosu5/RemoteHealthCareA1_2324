...
namespace BikeVRConnection.BikeConnection
{
    internal class EmulatedTrainer
    {
        ...
        public EmulatedTrainer()
        {
            ...
            distance = 0;
            gear = 1;
            currentTerrain = TerrainType.Flat; //Initializing to flat terrain
            previousSpeedData = GenerateSpeedData(); //Initializing with some realistic speed
        }
        ...
        private double CalculateSpeed(TerrainType terrain, int gear)
        {
            ...
            {
                previousSpeed = previousSpeedData[0];
            }
            ...
            double speed = smoothedSpeed * gearMultiplier;//Calculating speed after applying gear effect
        ...
        public byte[] GenerateHeartRateData()
        {
            ...
            smoothedSpeed += (speed - smoothedSpeed) * smoothingFactor;// Apply smoothing
        ...
        public byte[] GenerateSpeedData()
        {
            ...
            byte[] bytes = BitConverter.GetBytes((ushort)Math.Round(smoothedSpeed * 1000));// Convert smoothedSpeed to bytes
