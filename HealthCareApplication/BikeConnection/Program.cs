...
namespace TrainerDataTesting
{
    ...
    {
        /// <summary>
        /// Connects to either the regular BLE devices or uses a built-in simulator to generate random bytes.
        /// If the SimulatedReceiver class is instantiated, upon calling it's Connect() method, it will create
        ...
        {
            IReceiver receiver = new SimulatedReceiver();
